...
c     volgende regel is mijn toevoeging:
      open(21,file='/geo/home/jritsema/Utils/ellip/elcordir.tbl',access='direct',
...
c     my addition for SP and PS branches:
c ------------------------------------------------

      else if(phase(1:4).eq.'SP4a') then
c       phase='SP      '
        ip=55
      else if(phase(1:4).eq.'SP4b ') then
c       phase='SP      '
        ip=55
      else if(phase(1:4).eq.'SPab') then
c       phase='SP      '
        ip=55
      else if(phase(1:4).eq.'SPbc ') then
c       phase='SP      '
        ip=55
      else if(phase(1:4).eq.'SPcd') then
c       phase='SP      '
        ip=55

      else if(phase(1:4).eq.'PS4a') then
c       phase='PS      '
        ip=56
      else if(phase(1:4).eq.'PS4b ') then
c       phase='PS      '
        ip=56
      else if(phase(1:4).eq.'PSab') then
c       phase='PS      '
        ip=56
      else if(phase(1:4).eq.'PSbc ') then
c       phase='PS      '
        ip=56
      else if(phase(1:4).eq.'PScd') then
c       phase='PS      '
        ip=56
c ---------------------------------------------------
