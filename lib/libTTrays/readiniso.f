      ...
      subroutine readiniso
CC    SUBROUTINE TO READ IN COEFFICIENTS of ISOTROPIC PREM
      implicit double precision(a-h,o-z)
      common/coefs/ cofno(20,8,4),xb(20),xt(20),rnorm
c     rho Vp_iso Vs_iso 1/Q_mhu 1/Q_kappa Vp_iso Vs_iso eta
      open(512,file='/home/seiraid4/hendrikv/dta/noocean.mod.iso2',form='formatted',status='old')
