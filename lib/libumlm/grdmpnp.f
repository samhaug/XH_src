      subroutine grdmpnp(grid,igrid,ikla,iklo,rn,vn,rtop,rbot,ip1,ip2,rx
     1  ,del12,mess)
      character*(*) mess
      real lcon,ncon
c
...
c
    ...
    1   format('type lmin,lmax and n'/
     1       'or type return for defaults'/i1,3(1x,i1)/'* * * *')
        read(15,2) lminp,lmaxp,npp,ifeven
