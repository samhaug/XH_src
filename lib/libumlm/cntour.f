      subroutine cntour(work,con,jcon,icon,noverr,m1,m2,m3,
     *n1,n2,n3)
      ...
      rnx=float(m2-m1)
      rny=float(n2-n1)
c     call dwindo(0.5,rny-0.5,-0.2,rnx+0.8)
c     call dwindo(.5,rny+1.5,.5,rnx+1.5)
c     call dwindo(-.5,rny+.5,-.5,rnx+.5)
...
c
      call pecntr(work,m2,n2,m3,xmineff,xmax,noverr,jcon,0,0)
      return
      end
