...
cc 10 read(lu1) (iaddr(i),i=nfir,nlas)
   10 call bffi(lu1,1,iaddr4,(nlas-nfir+1)*2,jstat,nread,0)
      ...
      lmaxs=-1
      numbs=0
      write(6,'(10i7)') (iaddr(i),i=1,ltot+1)
      do 1 i=1,ltot
