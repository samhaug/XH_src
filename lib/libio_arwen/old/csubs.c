#include <sys/types.h>
#if ( defined(Machine4) | defined(Machine5) | defined(MachineA) | defined(Machinel) )
...
#if ( defined(Machine3) | defined(Machine4) | defined(Machine5) | defined(MachineA) | defined(Machinel)  )
...
#endif
#if ( defined(Machine4) | defined(Machine5) | defined(MachineT) | defined(MachineA) | defined(Machinel) )
